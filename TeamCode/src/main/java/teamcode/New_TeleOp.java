...
@TeleOp(name = "New_TeleOp", group = "14174")
public class New_TeleOp extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad2.left_bumper) {
                robot.slideLinear.setPosition(0.54);
            } else if (gamepad1.left_bumper) {
                robot.slideLinear.setPosition(0.45);
            } else {
                robot.slideLinear.setPosition(0.21);
            }
            if (gamepad2.left_trigger > 0.01) {
                robot.collectionTilt.setPosition(0.323);
                ...
                robot.collectionTilt.setPosition(0.83);
                robot.collectionIntake.setPower(0);
            }
            ...
            telemetry.addData("SlideRot", robot.front_left.getCurrentPosition());
            telemetry.addData("Spool", robot.front_right.getCurrentPosition());
            telemetry.addData("SlideRot", robot.back_left.getCurrentPosition());
            telemetry.addData("Spool", robot.back_right.getCurrentPosition());
            telemetry.update();
        }
    ...
    public void Collect () {
        robot.slideLinear.setPosition(0.5);
        robot.collectionTilt.setPosition(0.5);
    }
    public void Retract () {
        robot.collectionTilt.setPosition(0.5);
