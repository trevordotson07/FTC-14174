...
public class SpecimanA extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        */
        ...
        while (opModeIsActive()) {
            ...
            if (opState == 0) {
                driveStraightnoimu(-700, 0.75, 5, 0, 10);
                robot.collectionTilt.setPosition(0.83);
                robot.slideLinear.setPosition(0.21);
                //
                robot.slideRot.setTargetPosition(1310);
                robot.slideRot.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                robot.slideRot.setPower(0.95);
                sleep(1000);
                //
                robot.slideSpool.setTargetPosition(-2300);
                robot.slideSpool.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                robot.slideSpool.setPower(-0.95);
                sleep(2000);
                driveStraightnoimu(-75, 0.75, 5, 0, 10);
                sleep(500);
                robot.slideSpool.setTargetPosition(-1900);
                robot.slideSpool.setPower(0.95);
                sleep(500);
                driveStraightnoimu(-85, 0.5, 5, 0, 10);
                sleep(500);
                robot.slideSpool.setTargetPosition(100);
                sleep(1000);
                robot.slideSpool.setPower(0);
                robot.slideSpool.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
                sleep(500);
                driveStraightnoimu(300, 0.75, 10, 0, 10);
                sleep(500);
                turn(180,0.75,2);
                sleep(500);
                driveStrafe(2000, 0.75, 10, 180);
                sleep(500);
                turn(180,0.75,2);
                sleep(500);
                driveStraightnoimu(-550, 0.25, 5, 0, 1.5);
                sleep(500);
                robot.slideSpool.setTargetPosition(-500);
                robot.slideSpool.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                robot.slideSpool.setPower(-0.95);
                sleep(750);
                driveStraightnoimu(300, 0.75, 5, 180, 10);
                turn(180,0.75,2);
                driveStrafe(-2200, 0.75, 5, 180);
                turn(0,0.75,2);
                sleep(500);
                robot.slideSpool.setTargetPosition(-2050);
                robot.slideSpool.setPower(-0.95);
                sleep(1000);
                driveStraightnoimu(-150, 0.50, 5, 180, 10);
                robot.slideSpool.setTargetPosition(-1900);
                robot.slideSpool.setPower(0.95);
                sleep(500);
                driveStraightnoimu(-150, 0.15, 5, 180, 10);
                sleep(500);
                robot.slideSpool.setTargetPosition(100);
                sleep(1000);
                robot.slideSpool.setPower(0);
                ...
                robot.slideRot.setPower(-0.95);
                sleep(1000);
                driveStrafe(-2000, 0.75, 5, 180);
                driveStraightnoimu(500, 0.75, 5, 180, 10);
    ...
    public void driveStraightnoimu (double duration, double speedPercent, double error, double heading, double time) {
        double position = robot.front_left.getCurrentPosition();
        double target = position + duration;
        double distanceToTargetStart = Math.abs(target - position);
        double distanceToTarget = target - position;
